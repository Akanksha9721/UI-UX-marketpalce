...
const SignupSchema = Yup.object().shape({
  ...
  confirmPassword: Yup.string().required('Password repeat krna bhai')
...
const Signup = () => {
  ...
  return (
    ...
    <div className='mix-auto bg-no-repeat bg-cover bg-center' style={{ backgroundImage: `url('https://searchera.io/img/pattern.svg ')` }} >
