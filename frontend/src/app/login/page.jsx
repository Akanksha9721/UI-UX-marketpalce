...
const Login = () => {
  ...
  return (
    <div className=' h-screen mx-auto bg-no-repeat bg-cover bg-center' style={{ backgroundImage: `url('https://hitfigure.com/wp-content/uploads/2012/03/login-background.jpg')` }}>
