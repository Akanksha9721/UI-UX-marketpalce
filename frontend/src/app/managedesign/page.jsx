    ...
    <>
      <div className=' h-screen  bg-gray-100'>
        <div className='container mx-auto py-5 overflow-x-auto'>
          <h1 className='text-center text-2xl uppercase  font-bold  py-8 '>Manage Design</h1>
          <table className='w-full  min-w-max overflow-hidden rounded-lg shadow-lg'>
            <thead>
              <tr className='bg-gray-600 text-white font-bold text-center text-lg'>
                ...
                designList.map((design) => {
                  return (
                    <tr className='border bg-blue-200'>
                      ...
                      <td className='p-3 font-bold'>{design._id}</td>
                      <td className='p-3 fony-medium text-xl  '>{design.name}</td>
                      <td className='p-3 fony-medium text-xl '>₹{design.price}</td>
                      <td className='p-3 fony-medium text-xl'>{design.uploadBy}</td>
                      <td className='p-3 fony-medium text-xl '>{design.description}</td>
                      <td className='p-3 fony-medium text-xl '>{new Date(design.createdAt).toDateString()}</td>
                      <td className='p-3 fony-medium text-xl'>
