      ...
      <>
        ...
        <div className=' h-screen  mx-auto bg-no-repeat bg-cover bg-center ' style={{ backgroundImage: `url('https://png.pngtree.com/background/20220723/original/pngtree-background-biru-keren-dan-kosong-abstract-untuk-template-desain-powerpoint-ppt-picture-image_1738466.jpg')` }}>
          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div className="">
              <div className='  '>
                <h2 className=" mt-2 text-3xl text-gray-800 font-bold uppercase lg:text-4xl dark:text-white text-center">
                  About Us
                </h2>
              </div>
              {/* Grid */}
              <div className="grid grid-cols-12 gap-12">
                ...
                <img className='col-span-4 w-80 h-80  border border-white rounded-full transition-all duration-300 hover:scale-110  hover:border-gray-600  hover:shadow-lg hover:shadow-blue-500 shadow-lg ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQF8pps3k4729-29ZL3YcVXZupY0JmbbfXChg&s" alt="" />
                </div>
               
                <div className='col-span-8 space-y-6'>
                  <p className=" mt-8 text-gray-800 dark:text-neutral-400 text-medium lg:text-lg ">
